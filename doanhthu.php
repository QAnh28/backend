    ...
    <main>
        <div>
            <div class="container">
                ...
                <hr>
                <!--<table border="2px" bgcolor="#b3e5b5" cellpadding="10px" style="color:WHITE;">-->
                    ...
                    //if($ngaythue!="" ){
                        ...
                        //if($conn->query($sql)){
                            ...
                            /*while($row = mysqli_fetch_assoc($data)){
                                ...
                                echo"  TIen thue: ".$row["tien_thue"]."<br>";
                            ...
                            while($rows = mysqli_fetch_array($data)){
                                ...
                                <?php 
                                     //$sql="SELECT SUM(tien_thue) AS "tong doanh thu" FROM phieu_muon WHERE "//
                                    //$sql= "SELECT SUM(tien_thue) FROM phieu_muon WHERE tien_thue>5000d";
                                   /*$sql="SELECT SUM(tien_thue) AS 'Tong tien thue'
                                    FROM phieu_muon
                                    WHERE tien_thue > 0;"
