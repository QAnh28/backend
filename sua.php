    ...
    <main>
        <div>
            <div class="container">
                ...
                <?php 
                    if(isset($_POST["sua"])){
                        $ngaynhap = $_POST["ngaynhap"];    // Lấy thời gian hiện tại
                ...
                ?>
                <form action="" method="post" class="form1" id="sua1">
                        <h3>SỬA</h3>
                            <div>
                                <h5>Tên Truyện</h5>
                                <input type="text" name="têntruyện" value="<?php echo $rows['ten_truyen'] ?>"><br>
                            </div>
                            <div>
                                <h5>Ngày Nhập</h5>
                                <input type="text" name="ngaynhap" value="<?php echo $rows['ngay_nhap'] ?>"><br>
                                <!--<input type="text" name="ngaynhap" value="<?php echo date("Y-m-d"); ?>"><br>-->
                            </div>
                            <div>
                                <h5>Số lượng nhập vào</h5>
                                <input type="text" name="SLnhap" value="<?php echo $rows['so_luong_nhap'] ?>"><br>
                            </div>
                            <div>
                                <h5>Số lượng thuê</h5>
                                <input type="text" name="SLthue" placeholder="*bắt buộc" value="<?php echo $rows['so_luong_thue']?>"><br>
                            </div>
                            <div>
                                <h5>Giá truyện</h5>
                                <input type="text" name="giatruyen" value="<?php echo $rows['gia_truyen'] ?>"><br>
                            </div>
                            <div>
                                <h5>Nhà Xuất Bản</h5>
                                <input type="text" name="NXB" value="<?php echo $rows['nxb'] ?>"><br>
                            </div>
                            <div>
                                <h5>Tên Tác Giả</h5>
                                <input type="text" name="TenTG" value="<?php echo $rows['ten_tac_gia'] ?>"><br>
                            </div>
                            <div>
                                <h5>Thể loại</h5>
                                <input type="text" name="TL" value="<?php echo $rows['the_loai'] ?>"><br>
                            </div>
                            <button class="luu" name="sua">Lưu</button>
                </form>
</body>