    ...
    <main>
        <div>
            <div class="container">
                ...
                <?php
                    if(isset($_POST["them"])){
                        $ngaynhap = date("Y-m-d");    // Lấy thời gian hiện tại
                        ...
                        if($tentruyen!="" && $SLnhap!="" && $NXB!="" && $Gia!="" && $TGia!="" && $Tloai!=""){
                        // if($matruyen!="" && $tentruyen!="" && $SLnhap!="" && $NXB!="" && $Gia!="" && $TGia!="" && $Tloai!=""){
                            $sql = "INSERT INTO truyen(ten_truyen,ngay_nhap,so_luong_nhap,so_luong_thue,gia_truyen,nxb,ten_tac_gia,the_loai) VALUES('$tentruyen','$ngaynhap','$SLnhap','$SLthue','$Gia','$NXB','$TGia','$Tloai')";
                ...
                ?>
                <form action="" method="post" class="form1" id="them1">
                            <h3>THÊM</h3>
                            <div>
                                <h5>Tên Truyện</h5>
                                <input type="text" name="têntruyện" placeholder="*bắt buộc"><br>
                            </div>
                            <div>
                                <h5>Ngày Nhập</h5>
                                <input type="text" name="ngaynhap" value="<?php echo date("Y-m-d"); ?>" placeholder="*bắt buộc"><br>
                            </div>
                            <div>
                                <h5>Số lượng nhập vào</h5>
                                <input type="text" name="SLnhap" placeholder="*bắt buộc"><br>
                            </div>
                            <div>
                                <h5>Số lượng thuê</h5>
                            ...
                            <div>
                                <h5>Giá truyện</h5>
                                <input type="text" name="giatruyen" placeholder="*bắt buộc"><br>
                            </div>
                            <div>
                                <h5>Nhà Xuất Bản</h5>
                                <input type="text" name="NXB" placeholder="*bắt buộc"><br>
                            </div>
                            <div>
                                <h5>Tên Tác Giả</h5>
                                <input type="text" name="TenTG" placeholder="*bắt buộc"><br>
                            </div>
                            <div>
                                <h5>Thể loại</h5>
                                <input type="text" name=TL placeholder="*bắt buộc"><br>
                            </div>
                            <button type="submit" class="luu" name="them" values="them">Lưu</button>
                </form>
</body>