    ...
    <main>
        <div>
            <div class="container">
                ...
                <div id="right" class="col-md-9 col-lg-9" style="padding-left:5%;" style="color:white;" >
                <div class="tke">
                <h1>THỐNG KÊ TRUYỆN THUÊ</h1>
                <hr>
                    <form action="" method="POST">
                        <input type="text" name="ngaythue" placeholder="*yyyy/mm/dd">
                    ...
                    $arrKeyWord = explode(' ',$ngaythue);
                    //chuyển mảng thành xâu
                    $endKeyWord = '%'.implode('%',$arrKeyWord).'%';
                    // var_dump($ngaythue);
                    //if($ngaythue!="" ){
                        $sql= "SELECT * FROM phieu_muon WHERE ngay_thue LIKE '$endKeyWord'";
                        //if($conn->query($sql)){
